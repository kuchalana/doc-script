...
// global arrays
// ---------------------------------------------------
//modified by kuchalana
// www.bloggerlelaki.com
// date : 18-11-2015
...
function hideToc() {
  ...
  tocdiv.innerHTML = '';
  var toclink = document.getElementById("toclink");
  toclink.innerHTML = '<a href="#" onclick="scroll(0,0); showToc(); Effect.toggle('+"'toc-result','blind');"+'">» Show Table of Contents</a> <img src="http://2.bp.blogspot.com/-0byNfgakpcg/Vkv6aVeu8wI/AAAAAAAAIOM/xGV4KTBEF_s/s1600/new.gif"/>';
}
